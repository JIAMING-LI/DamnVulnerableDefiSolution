...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const sideEntranceLenderPoolAttackeFactory = await ethers.getContractFactory("SideEntranceLenderPoolAttacker");
        const contract = await sideEntranceLenderPoolAttackeFactory.deploy(this.pool.address).then(c => c.connect(attacker));
